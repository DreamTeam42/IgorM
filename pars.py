...
def parse(html):
    ...
    e8 = soup.find('div',class_='block-tbl-div').find('tbody', id = 'tblBidsbody' ).find('table', class_='block read-only').find_all('td',class_='block-data')[8].text
    e9 = soup.find('div',class_='block-tbl-div').find('tbody', id = 'tblBidsbody' ).find('table', class_='block read-only').find_all('td', class_='block-data')[9].text
    e10 = soup1.find('bids').find('okpd2idname').text
    e11 = soup.find('div',class_='block-tbl-div').find('tbody', id = 'tblBidsbody' ).find('table', class_='block read-only').find_all('td', class_='block-data')[11].find('tr').text
    ...
    e12 = soup1.find('docsdiv').find_all('fileid')
    #Массив для id
    mass6 = list()
